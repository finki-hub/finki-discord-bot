...
export const aboutMessage = (helpCommand: string, faqCommand: string) =>
  `Овој Дискорд бот е развиен од ${userMention(
    '198249751001563136',
  )} за потребите на ${hyperlink('ФИНКИ Хаб', 'https://finki-hub.com')}, независната студентска организација. Кодот е отворен и се наоѓа на ${hyperlink(
    'GitHub',
    'https://github.com/finki-hub/discord-bot',
